...
static APP_CSS: Stylesheet = Stylesheet { id: "tw-app", css: ".p-4{padding:1rem}", per_class: None, scripts: &[] };
static APP_STYLESHEETS: &[&Stylesheet] = &[&APP_CSS];
static PAGE_B_CSS: Stylesheet = Stylesheet { id: "pagebcss", css: "h1{color:red}", per_class: None, scripts: &[] };
