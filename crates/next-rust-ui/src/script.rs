//! Browser behavior of the interactive components, served at `/_nr/ui.js`.
//!
...
// select, the calendar, the password toggle, `on_press` and the drawer.
...
/// [`UI_JS`], minified.
pub const UI_JS_MIN: &str = r####"const e=()=>window.nextRust||{},t=document.documentElement;t.classList.add("nr-ui-js");const n=new Map;function a(e){for(const[t,a]of n)t!==e&&a()}document.addEventListener("pointerdown",e=>{for(const[t,a]of n)t.contains(e.target)||a()},!0);const r="function"==typeof HTMLElement.prototype.showPopover,o=new Map;function s(e,t,n){const a=t.getBoundingClientRect();if(!r){e.removeAttribute("data-placement"),e.removeAttribute("data-align");const t=e.offsetHeight;return a.bottom+t+12>innerHeight&&a.top-t-12>0&&(e.dataset.placement="top"),void(a.left+e.offsetWidth+8>innerWidth&&a.right-e.offsetWidth>0&&(e.dataset.align="end"))}const o=n?a.width+4:e.offsetWidth,s=Math.max(8,Math.min(a.left-2,innerWidth-o-8)),l=e.offsetHeight,i=a.bottom+6+l<=innerHeight-8||a.top-6-l<8;e.dataset.placement=i?"bottom":"top",Object.assign(e.style,{position:"fixed",inset:"auto",margin:"0",left:`${s}px`,top:`${i?a.bottom+6:a.top-6-l}px`,width:n?`${o}px`:""})}function l(e,t,n){e.hidden=!1,r&&(e.popover="manual",e.showPopover(),o.set(e,[t,n])),s(e,t,n)}function i(e){r&&e.matches(":popover-open")&&e.hidePopover(),o.delete(e),e.hidden=!0}const d=()=>{for(const[e,[t,n]]of o)s(e,t,n)};addEventListener("scroll",d,{capture:!0,passive:!0}),addEventListener("resize",d,{passive:!0});const c=new WeakSet;function u(e){if(c.has(e))return;c.add(e);const r=e.dataset.nrUi;"select"===r?function(e){const t=e.querySelector(".nr-select-native"),r=e.querySelector(".nr-select-trigger"),o=e.querySelector(".nr-select-list"),s=e.querySelector(".nr-select-value"),d=e.querySelector(".nr-field-wrap");if(!(t&&r&&o&&s))return;const c=t.multiple,u=[...t.options].find(e=>""===e.value),f=u?u.textContent:"",p=()=>[...o.querySelectorAll('[role="option"]')],m=()=>p().filter(e=>"true"!==e.getAttribute("aria-disabled"));let h=null,v="",b=0;function y(){const n=new Set([...t.selectedOptions].map(e=>e.value).filter(e=>""!==e)),a=[];for(const e of p()){const t=n.has(e.dataset.value);e.setAttribute("aria-selected",String(t)),t&&a.push(e.querySelector(".nr-select-option-label").textContent)}s.textContent=a.length?a.join(", "):f,s.toggleAttribute("data-placeholder",!a.length),e.toggleAttribute("data-filled",a.length>0)}function w(e,t=!0){h&&h.removeAttribute("data-active"),h=e||null,h?(h.setAttribute("data-active",""),r.setAttribute("aria-activedescendant",h.id),t&&h.scrollIntoView({block:"nearest"})):r.removeAttribute("aria-activedescendant")}function k(){o.hidden&&!t.disabled&&(a(e),l(o,d,!0),e.setAttribute("data-open",""),r.setAttribute("aria-expanded","true"),w(m().find(e=>"true"===e.getAttribute("aria-selected"))||m()[0]),n.set(e,D))}function D(t){o.hidden||(i(o),e.removeAttribute("data-open"),r.setAttribute("aria-expanded","false"),w(null),n.delete(e),!0===t&&r.focus())}function E(e){if(!e||"true"===e.getAttribute("aria-disabled"))return;const n=[...t.options].find(t=>t.value===e.dataset.value);n&&(n.selected=!c||!n.selected,g(t),y(),c||D(!0))}r.addEventListener("click",()=>o.hidden?k():D()),d.addEventListener("click",e=>{e.target.closest(".nr-select-list, .nr-select-trigger")||(r.focus(),o.hidden?k():D())}),o.addEventListener("mousedown",e=>e.preventDefault()),o.addEventListener("pointermove",e=>{const t=e.target.closest('[role="option"]');t&&t!==h&&"true"!==t.getAttribute("aria-disabled")&&w(t,!1)}),o.addEventListener("click",e=>{e.stopPropagation(),E(e.target.closest('[role="option"]'))}),r.addEventListener("keyup",e=>{" "===e.key&&e.preventDefault()}),r.addEventListener("keydown",e=>{const t=m(),n=t.indexOf(h);switch(e.key){case"ArrowDown":e.preventDefault(),o.hidden?k():w(t[Math.min(n+1,t.length-1)]||t[0]);break;case"ArrowUp":e.preventDefault(),o.hidden?k():w(t[Math.max(n-1,0)]);break;case"Home":case"End":o.hidden||(e.preventDefault(),w("Home"===e.key?t[0]:t[t.length-1]));break;case"Enter":case" ":e.preventDefault(),o.hidden?k():E(h);break;case"Escape":o.hidden||(e.preventDefault(),D(!0));break;case"Tab":D();break;default:if(1===e.key.length&&!e.ctrlKey&&!e.metaKey&&!e.altKey){const n=Date.now();v=n-b>700?e.key:v+e.key,b=n;const a=v.toLowerCase(),r=t.find(e=>e.textContent.trim().toLowerCase().startsWith(a));r&&(o.hidden&&k(),w(r))}}}),e.querySelector(".nr-field-label")?.addEventListener("click",e=>{e.preventDefault(),r.focus()}),t.addEventListener("change",y),t.form&&t.form.addEventListener("reset",()=>setTimeout(y)),y()}(e):"datepicker"===r?function(e){const r=e.querySelector(".nr-datepicker-input"),o=e.querySelector(".nr-calendar"),d=e.querySelector(".nr-field-wrap");if(!r||!o||!d)return;const c=e.dataset.locale||t.lang||void 0,u=+(e.dataset.firstDay||0),f=k(r.min),p=k(r.max),m=()=>{const e=new Date;return new Date(e.getFullYear(),e.getMonth(),e.getDate())},h=e=>(!f||e>=f)&&(!p||e<=p),E=new Intl.DateTimeFormat(c,{dateStyle:"medium"}),A=new Intl.DateTimeFormat(c,{dateStyle:"full"}),S=new Intl.DateTimeFormat(c,{month:"long",year:"numeric"}),x=new Intl.DateTimeFormat(c,{month:"short"}),L=new Intl.DateTimeFormat(c,{weekday:"short"}),M=document.createElement("input");M.type="hidden",M.name=r.name,r.removeAttribute("name"),r.after(M);let q=k(r.value);r.type="text",r.autocomplete="off",r.setAttribute("inputmode","none"),r.setAttribute("aria-haspopup","dialog"),r.addEventListener("beforeinput",e=>e.preventDefault());const F=()=>{r.value=q?E.format(q):"",M.value=q?v(q):""};F();let Y="days",T=q||m();function C(e,t,n){const a=document.createElement("button");a.type="button",a.className=e;for(const[e,n]of Object.entries(t))!1!==n&&null!=n&&a.setAttribute(e,!0===n?"":n);return a.innerHTML=n,a}function P(e){o.textContent="",o.dataset.view=Y;const t=document.createElement("div");t.className="nr-cal-header";const n="days"===Y,a=n?D(w(T),-1):new Date(T.getFullYear()-1,11,31),r=n?D(w(T),1):new Date(T.getFullYear()+1,0,1),l=n?new Date(a.getFullYear(),a.getMonth()+1,0):a;if(t.append(C("nr-cal-nav",{"data-cal":"prev","aria-label":n?"Previous month":"Previous year",disabled:!!f&&l<f},'<svg class="nr-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m15 18-6-6 6-6"/></svg>'),C("nr-cal-title",{"data-cal":"view","aria-live":"polite"},`<span>${n?S.format(T):T.getFullYear()}</span><svg class="nr-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m6 9 6 6 6-6"/></svg>`),C("nr-cal-nav",{"data-cal":"next","aria-label":n?"Next month":"Next year",disabled:!!p&&r>p},'<svg class="nr-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m9 18 6-6-6-6"/></svg>')),o.append(t),n){const e=document.createElement("div");e.className="nr-cal-grid",e.setAttribute("role","grid");for(let t=0;t<7;t++){const n=document.createElement("div");n.className="nr-cal-weekday",n.setAttribute("role","columnheader"),n.textContent=L.format(new Date(2023,0,1+(t+u)%7)),e.append(n)}const t=w(T),n=(t.getDay()-u+7)%7,a=m();for(let r=0;r<42;r++){const o=y(t,r-n);e.append(C("nr-cal-day",{role:"gridcell","data-date":v(o),"aria-label":A.format(o),"aria-selected":b(o,q)?"true":"false","data-today":b(o,a),"data-outside":o.getMonth()!==T.getMonth(),tabindex:b(o,T)?"0":"-1",disabled:!h(o)},String(o.getDate())))}o.append(e)}else{const e=document.createElement("div");e.className="nr-cal-months";for(let t=0;t<12;t++){const n=new Date(T.getFullYear(),t,1),a=new Date(T.getFullYear(),t+1,0);e.append(C("nr-cal-month",{"data-month":String(t),"aria-selected":q&&q.getFullYear()===T.getFullYear()&&q.getMonth()===t?"true":"false","data-current":t===T.getMonth(),tabindex:t===T.getMonth()?"0":"-1",disabled:!!f&&a<f||!!p&&n>p},x.format(n)))}o.append(e)}const i=document.createElement("div");i.className="nr-cal-footer",i.append(C("nr-cal-link",{"data-cal":"today",disabled:!h(m())},"Today"),C("nr-cal-link",{"data-cal":"clear"},"Clear")),o.append(i),o.hidden||s(o,d,!1),e&&o.querySelector('[tabindex="0"]:not(:disabled)')?.focus({preventScroll:!0})}function H(){!o.hidden||r.disabled||r.readOnly||(a(e),Y="days",T=q||(h(m())?m():f||p||m()),P(!1),l(o,d,!1),e.setAttribute("data-open",""),e.querySelector(".nr-datepicker-toggle")?.setAttribute("aria-expanded","true"),o.querySelector('[tabindex="0"]:not(:disabled)')?.focus({preventScroll:!0}),n.set(e,N))}function N(t){o.hidden||(i(o),e.removeAttribute("data-open"),e.querySelector(".nr-datepicker-toggle")?.setAttribute("aria-expanded","false"),n.delete(e),!0===t&&r.focus({preventScroll:!0}))}function W(e){q=e,F(),g(M),N(!0)}function $(e){f&&e<f&&(e=f),p&&e>p&&(e=p),T=e,P(!0)}o.addEventListener("click",e=>{const t=e.target.closest("button");t&&!t.disabled&&(t.dataset.date?W(k(t.dataset.date)):t.dataset.month?(T=new Date(T.getFullYear(),+t.dataset.month,Math.min(T.getDate(),28)),Y="days",P(!0)):"prev"===t.dataset.cal?(T="days"===Y?D(T,-1):new Date(T.getFullYear()-1,T.getMonth(),1),P(!1)):"next"===t.dataset.cal?(T="days"===Y?D(T,1):new Date(T.getFullYear()+1,T.getMonth(),1),P(!1)):"view"===t.dataset.cal?(Y="days"===Y?"months":"days",P(!0)):"today"===t.dataset.cal?W(m()):"clear"===t.dataset.cal&&(q=null,F(),g(M),N(!0)))}),o.addEventListener("keydown",e=>{if("Escape"===e.key)return e.preventDefault(),void N(!0);const t=e.target.dataset&&e.target.dataset.date,n=e.target.dataset&&null!=e.target.dataset.month;if(!t&&!n)return;const a={ArrowLeft:-1,ArrowRight:1,ArrowUp:t?-7:-3,ArrowDown:t?7:3}[e.key];if(null!=a)if(e.preventDefault(),t)$(y(T,a));else{const e=Math.min(11,Math.max(0,T.getMonth()+a));T=new Date(T.getFullYear(),e,1),P(!0)}else if(!t||"PageUp"!==e.key&&"PageDown"!==e.key){if(t&&("Home"===e.key||"End"===e.key)){e.preventDefault();const t=(T.getDay()-u+7)%7;$(y(T,"Home"===e.key?-t:6-t))}}else e.preventDefault(),$(D(T,("PageUp"===e.key?-1:1)*(e.shiftKey?12:1)))}),e.addEventListener("focusout",t=>{o.hidden||!t.relatedTarget||e.contains(t.relatedTarget)||N()}),r.addEventListener("click",H),r.addEventListener("keydown",e=>{"Enter"===e.key||" "===e.key||"ArrowDown"===e.key?(e.preventDefault(),H()):"Backspace"!==e.key&&"Delete"!==e.key||!q||r.required||(e.preventDefault(),q=null,F(),g(M))}),d.addEventListener("click",e=>{e.target.closest(".nr-calendar")||(e.target.closest(".nr-datepicker-toggle")&&!o.hidden?N(!0):H())}),r.form&&r.form.addEventListener("reset",()=>setTimeout(()=>{q=k(r.defaultValue),F()}))}(e):"avatar"===r&&function(e){const t=e.querySelector(".nr-avatar-img");if(!t)return;const n=()=>t.hidden=!0;t.complete&&0===t.naturalWidth&&t.getAttribute("src")?n():t.addEventListener("error",n,{once:!0})}(e)}function f(e){e.matches&&e.matches("[data-nr-ui]")&&u(e);for(const t of e.querySelectorAll("[data-nr-ui]"))u(t)}const p=(e,t,n)=>e.dispatchEvent(new CustomEvent(t,{bubbles:!0,detail:n})),g=e=>{e.dispatchEvent(new Event("input",{bubbles:!0})),e.dispatchEvent(new Event("change",{bubbles:!0}))};function m(e){const t=document.querySelector(".nr-shell");if(t){t.toggleAttribute("data-open",e);for(const t of document.querySelectorAll(".nr-navbar-menu"))t.setAttribute("aria-expanded",String(e))}}document.addEventListener("click",async t=>{const n=t.target.closest&&t.target.closest("[data-nr-press]");if(!n||n.matches(':disabled, [aria-disabled="true"], [data-loading]'))return;const a=n.dataset.nrPress,r=n.dataset.nrPressTarget||"";if("navigate"===a)t.preventDefault(),e().navigate?e().navigate(r):location.href=r;else if("emit"===a)p(n,"nr:"+r,null);else if("action"===a){t.preventDefault();let a=null;try{a=JSON.parse(n.dataset.nrPressInput||"null")}catch{}n.setAttribute("data-loading",""),n.setAttribute("aria-busy","true");try{const t=await e().action(r,a);p(n,"nr:success",t),"false"!==n.dataset.nrPressRefresh&&e().refresh&&e().refresh()}catch(e){p(n,"nr:error",e),n.hasAttribute("data-nr-quiet")||console.error("[next-rust] action failed:",e.message)}finally{n.removeAttribute("data-loading"),n.removeAttribute("aria-busy")}}}),document.addEventListener("keydown",e=>{const t=e.target;("Enter"===e.key||" "===e.key)&&t.matches&&t.matches('[data-nr-press][role="button"]')&&(e.preventDefault(),t.click())}),document.addEventListener("click",e=>{const t=e.target.closest&&e.target.closest("[data-nr-field-action]");if(t){const e=t.closest(".nr-field")?.querySelector("input.nr-field-input, textarea.nr-field-input"),n=t.dataset.nrFieldAction;if("toggle-password"===n&&e){const n="password"===e.type;e.type=n?"text":"password",t.setAttribute("aria-pressed",String(n)),t.setAttribute("aria-label",n?"Hide password":"Show password"),e.focus({preventScroll:!0});const a=e.value.length;e.setSelectionRange(a,a)}else"clear"===n&&e&&(e.value="",g(e),e.focus());return}const n=e.target.closest&&e.target.closest(".nr-input .nr-field-wrap, .nr-textarea .nr-field-wrap");n&&!e.target.closest("input, textarea, button, a, select")&&n.querySelector(".nr-field-input")?.focus()}),document.addEventListener("click",e=>{e.target.closest&&e.target.closest("[data-nr-shell-toggle]")?m(!document.querySelector(".nr-shell[data-open]")):e.target.closest&&e.target.closest(".nr-shell-sidebar a[href]")&&m(!1)}),window.addEventListener("nr:navigate",()=>m(!1)),document.addEventListener("keydown",e=>{"Escape"===e.key&&document.querySelector(".nr-shell[data-open]")&&m(!1)});const h=(e,t=2)=>String(e).padStart(t,"0"),v=e=>`${h(e.getFullYear(),4)}-${h(e.getMonth()+1)}-${h(e.getDate())}`,b=(e,t)=>!!e&&!!t&&v(e)===v(t),y=(e,t)=>new Date(e.getFullYear(),e.getMonth(),e.getDate()+t),w=e=>new Date(e.getFullYear(),e.getMonth(),1);function k(e){const t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(e||"");if(!t)return null;const n=new Date(+t[1],+t[2]-1,+t[3]);return n.getMonth()===+t[2]-1?n:null}function D(e,t){const n=new Date(e.getFullYear(),e.getMonth()+t,1),a=new Date(n.getFullYear(),n.getMonth()+1,0).getDate();return new Date(n.getFullYear(),n.getMonth(),Math.min(e.getDate(),a))}f(document),new MutationObserver(e=>{for(const t of e)for(const e of t.addedNodes)1===e.nodeType&&f(e)}).observe(t,{childList:!0,subtree:!0});"####;
...
mod tests {
    ...
    const UI_JS_SOURCE_HASH: &str = "fa305b73a6427198";
