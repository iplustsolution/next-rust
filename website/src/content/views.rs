...
pub fn content() -> Node {
    ...
    img![src("/cat.jpg"), alt("A cat")],
        ...
        p![
            ...
            ", ",
            code!["marker"],
            ", …). Their macros keep SVG's own casing: ",
            code!["foreignObject![..]"],
            ", ",
            code!["feGaussianBlur![..]"],
            ".",
...
Link!(href = "/step/2", replace = true, scroll = false, "Next")"#,
        ...
        p![
            ...
            " also navigates without a page refresh, and prefetches when the mouse rests on it for 400 ms. Use ",
            code!["reload(true)"],
            " on a link that must do a full page load. See ",
            a![href("/docs/client#prefetching"), "Client & navigation"],
            ".",
        ],
...
Image!(src = "/hero.jpg", width = 1920, height = 1080, alt = "", priority = true, sizes = "100vw")"#,
        ...
        p![
            ...
            ". See ",
            a![href("/docs/styling-and-assets#images"), "Styling & assets"],
