...
:root {
  ...
  --line-strong: #2f2f37;
  --accent: #f46a25;
  --accent-soft: rgba(244, 106, 37, 0.12);
  --accent-fg: #ff8a4c;
  --on-accent: #140800;
  --code-bg: #101013;
...
@media (prefers-color-scheme: light) {
  :root {
    ...
    --line-strong: #dcdce2;
    --accent: #e0561a;
    --accent-soft: rgba(224, 86, 26, 0.09);
    --accent-fg: #c2410c;
    --on-accent: #ffffff;
    --code-bg: #fafafa;
...
.cta {
  ...
  border: 1px solid var(--line);
  border-radius: 20px;
  background: radial-gradient(60% 120% at 50% 0%, var(--accent-soft), transparent 70%), var(--bg-soft);
  text-align: center;
}
...
.prose a:not(.anchor):not(.card) {
  color: var(--accent-fg);
  text-decoration: underline;
  text-decoration-color: color-mix(in srgb, var(--accent-fg) 35%, transparent);
  text-underline-offset: 3px;
  transition: text-decoration-color 0.15s;
}

.prose a:not(.anchor):not(.card):hover {
